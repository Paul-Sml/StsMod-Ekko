...
public class BottledSheen extends AbstractPotion {
    ...
    public static final String POTION_ID = EkkoMod.makeID("BottledSheen");
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            this.addToBot(new ApplyPowerAction(target, AbstractDungeon.player, new SheenPower(target, AbstractDungeon.player, potency), potency));
        }
    }
