...
public class LoseDexterityPowerBuff extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = EkkoMod.makeID("LoseDexterityPowerBuff");
    ...
    public LoseDexterityPowerBuff(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new LoseDexterityPowerBuff(owner, source, amount);
    }
}
