...
public class PhasingArmor extends AbstractDynamicCard {

    public static final String ID = EkkoMod.makeID(PhasingArmor.class.getSimpleName());
    public static final String IMG = makeCardPath("PhasingArmor.png");
